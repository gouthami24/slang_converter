...
def convert_to_local_slang(text, target_language):
    ...
    prompt=f"translate{text} in {target_language} slang"
...
target_language = st.selectbox('Select target language:', ['Texan','British','Australian','Canadian','Southern', 'Midwest','Boston', 'Chicago', 'New England'])  
